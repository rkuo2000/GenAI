...
access_token = "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"

model = AutoModelForCausalLM.from_pretrained(model_name, torch_dtype=torch.bfloat16, device_map="cuda", token=access_token)
